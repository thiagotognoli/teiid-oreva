...
/**
 * 
 * This class uses URLEncoder to Encode the String and URLDecoder to decode the
 * String.
 * <ol>
 ...
 * bytes using some encoding scheme.</li>
 * </ol>
 * Then each byte is represented by the 3-character string "%xy", where xy is
 * the two-digit hexadecimal representation of the byte.<br>
...
public class ConversionUtil {
    ...
    public static String encodeString(String stringToEncode) {
        ...
        if (stringToEncode != null) {
            try {
                encodedString = ConversionUtil
                        .removeUnsuportedCharacter(URLEncoder.encode(stringToEncode, encodingOrDecodingScheme));
    ...
    public static MultivaluedMap<String, String> decodeQueryString(URI uri) {
        ...
        while (st.hasMoreTokens()) {
            ...
            try {
                ...
                log.warning(
                        "ConversionUtil failed to decode a query string:" + param + "\nthe error is" + e.getMessage());
