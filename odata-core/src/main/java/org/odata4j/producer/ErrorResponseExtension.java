 ...
 *
 * <p>
 * To expose this extension, the producer implementation has to return an
 * instance of this
 * interface when method {@code findExtension} is called and the first parameter
 * is equal to
 * {@code ErrorResponseExtension.class}.
 * </p>
 *
...
public interface ErrorResponseExtension extends OExtension<ODataProducer> {
  ...
  /**
   * This method is called before an error response is created and sent to the
   * client. Thus
   * producers can decide if an inner error should be returned or not. This
   ...
   * @return flag indicating whether to return an inner error as part of the error
   *         response to the
   *         client or not
   */
