...
/**
 * An optional extension that a producer can expose to work with Media Link
 * Entries.
 */
public interface OMediaLinkExtension extends OExtension<ODataProducer> {
   ...
   */
  InputStream getInputStreamForMediaLinkEntry(ODataContext odataContext, OEntity mle, String etag,
   ...
   */
  OutputStream getOutputStreamForMediaLinkEntryCreate(ODataContext odataContext, OEntity mle, String etag,
      QueryInfo query);
   ...
   */
  OutputStream getOutputStreamForMediaLinkEntryUpdate(ODataContext odataContext, OEntity mle, String etag,
      QueryInfo query);
   ...
   * @param httpHeaders Atom protocol says the Slug header can contain additional
   *                    create info.
   ...
   * @return the entity
   */
  OEntity getMediaLinkEntryForUpdateOrDelete(ODataContext odataContext, EdmEntitySet entitySet, OEntityKey key,
